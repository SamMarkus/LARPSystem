...
public class AISensoryMemory
{
    ...
    public AISensoryMemory(int maxPlayers, string layer)
    {
    ...
    {
        int targets = sensor.Filter(characters, filterLayer);
    ...
    public void ForgetMemories(float olderThan)
    {
        ...
        // memories.RemoveAll(m => m.gameObject.GetComponent<Health>().IsDead()); // For use with a health component
    }
}
